<template>
  <div class="bg-gradient-to-br from-teal-400 to-indigo-500 dark:from-teal-800 dark:to-indigo-900 p-1 rounded-2xl shadow-xl">
    <form @submit.prevent="submitForm" class="bg-white dark:bg-gray-800 rounded-2xl p-6 space-y-6">
      <h2 class="text-3xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-r from-teal-500 to-indigo-600 dark:from-teal-300 dark:to-indigo-400">
        {{ isEditMode ? 'Edit Food Component' : 'New Food Component' }}
      </h2>
      ...
      <div class="relative">
        <input
          ...
          type="text"
          required
          class="peer w-full px-4 py-3 rounded-lg bg-gray-100 dark:bg-gray-700 border-2 border-transparent focus:border-teal-500 dark:focus:border-teal-400 focus:outline-none transition duration-300 placeholder-transparent"
          placeholder="Name"
        />
        <label
          for="name"
      ...
      <div class="relative">
        <textarea
          ...
          rows="4"
          class="peer w-full px-4 py-3 rounded-lg bg-gray-100 dark:bg-gray-700 border-2 border-transparent focus:border-teal-500 dark:focus:border-teal-400 focus:outline-none transition duration-300 placeholder-transparent resize-none"
