<template>
  <div class="bg-gradient-to-br from-emerald-400 to-cyan-500 dark:from-emerald-800 dark:to-cyan-900 p-1 rounded-2xl shadow-xl">
    <form @submit.prevent="submitForm" class="bg-white dark:bg-gray-800 rounded-2xl p-6 space-y-6">
      ...
      <div class="relative">
        <input
          ...
          type="text"
          required
          class="peer w-full px-4 py-3 rounded-lg bg-gray-100 dark:bg-gray-700 border-2 border-transparent focus:border-emerald-500 dark:focus:border-emerald-400 focus:outline-none transition duration-300 placeholder-transparent"
          placeholder="Name"
        />
        <label
          for="name"
      ...
      <div class="relative">
        <textarea
          ...
          rows="4"
          class="peer w-full px-4 py-3 rounded-lg bg-gray-100 dark:bg-gray-700 border-2 border-transparent focus:border-emerald-500 dark:focus:border-emerald-400 focus:outline-none transition duration-300 placeholder-transparent resize-none"
