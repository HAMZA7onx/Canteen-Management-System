<template>
  <div class="admin-report-subscription-dashboard p-4 md:p-6 bg-gray-100 dark:bg-gray-900 min-h-screen">
    <h1 class="text-3xl font-bold mb-6 text-gray-800 dark:text-white">Abonnements aux rapports d'administration</h1>

    <!-- Add New Subscription Form -->
    <div class="mb-8 bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
      <h2 class="text-2xl font-semibold mb-4 text-gray-700 dark:text-gray-200">Ajouter un nouvel abonnement</h2>
      <form @submit.prevent="addSubscription" class="space-y-4">
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700 dark:text-gray-300" for="frequency">Fréquence</label>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
      <h2 class="text-2xl font-semibold p-6 border-b border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200">Abonnements actuels</h2>
...
export default {
  ...
  setup() {
    ...
    const getAdminName = (subscription) => {
      ...
      return admin ? admin.name : 'Administrateur inconnu'
    }

    const getAdminEmail = (subscription) => {
      const admin = admins.value.find(a => a.id === subscription.admin_id)
      return admin ? admin.email : 'E-mail non disponible'
    }
