<template>
  <div class="bg-white rounded-lg p-6">
    ...
    <div class="mb-4">
      ...
      <select id="user" v-model="selectedUser" class="border border-gray-300 rounded-md px-3 py-2 w-full">
...
export default {
  ...
  created() {
    console.log('Eligible Users (AssignRfidModal.vue):', this.eligibleUsers);
  },
  methods: {
