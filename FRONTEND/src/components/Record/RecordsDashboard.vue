<template>
  <div class="records-dashboard p-2 sm:p-6 pt-16 sm:pt-24 min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 dark:from-gray-900 dark:to-indigo-900 transition-all duration-300">
    ...
    <div v-else class="flex flex-col items-center justify-center h-64 bg-white dark:bg-gray-800 rounded-lg shadow-xl">
      ...
      <h3 class="text-xl font-semibold text-gray-700 dark:text-gray-300 mb-2">Aucun enregistrement trouvé</h3>
      <p class="text-gray-500 dark:text-gray-400 text-center">Il semble qu'aucun enregistrement ne soit disponible pour le moment. Revenez plus tard ou essayez de rafraîchir la page.</p>
    </div>
  </div>
</template>
