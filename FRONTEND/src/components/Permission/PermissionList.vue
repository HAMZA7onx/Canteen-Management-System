<template>
  <div class="container mx-auto px-4">
    ...
    <Overlay v-if="showCreatePermissionModal">
      <Modal :show="showCreatePermissionModal" @close="closeCreatePermissionModal" title="Create Permission">
        <PermissionForm :permission="{}" @update:permission="createPermission" />
      </Modal>
    </Overlay>

    <!-- Edit Permission Modal -->
    <Overlay v-if="showEditPermissionModal">
      <Modal :show="showEditPermissionModal" @close="closeEditPermissionModal" title="Edit Permission">
        <PermissionForm :permission="selectedPermission" @update:permission="updatePermission" />
      </Modal>
    </Overlay>
...
export default {
  ...
  methods: {
    ...mapActions('permission', ['fetchPermissions', 'createPermission', 'deletePermission']),
    ...
    updatePermission(updatedPermission) {
      this.$store
        .dispatch('permission/updatePermission', updatedPermission)
        .then(() => {
    ...
    confirmDeletePermission() {
      this.$store
        .dispatch('permission/deletePermission', this.permissionToDelete.id)
        .then(() => {
